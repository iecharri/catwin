...
<?php
include("arriba.php");
$menu12=3;include("menusizda.php");

if (!$cuenta) {

	echo "<form method='post' name='form1'>Cuenta: <input type='text' name='cuenta' size='3' maxlength='3'> \n";
...
$result = $link->query("SELECT * FROM cuentas WHERE cuenta = $cuenta"); 
...
while ($fila = $result->fetch_array(MYSQLI_BOTH)) :
	...
	if ($fila[0] = $cuenta) {
		echo "<h2>Cuenta: ".$cuenta." ".$fila[2]."</h2>";
		break;
	}
...
if ($result->num_rows == 0) {
	...
	echo "<p /><br /><p />No hay Apuntes para el Nº de Cuenta <span class='b'>$cuenta</span>.";
	exit;
...
echo "<tr><th>Fecha</th><th>Subcuenta</th><th>Asiento</th><th>Concepto</th><th class='dcha'>Debe</th><th class='dcha'>Haber</th></tr> \n";
