...
$sql = "INSERT INTO apuntes (asiento, fecha, tipo, cuenta, concepto, debe, ip) VALUES ('$asiento', '$fecha', 'F. Recibida', '47200000',"." 'Fr. nº ".$fact." de ".$proveed."', '".$tipivar1."', '$ip')"; 
if (!$link->query($sql)) die ("El usuario $usuario no tiene permiso para a&ntilde;adir Apuntes.");
...
$sql = "INSERT INTO apuntes (asiento, fecha, tipo, cuenta, concepto, haber, ip) VALUES ('$asiento', '$fecha', 'F. Recibida',  '47200000', 'Abono nº ".$fact." de. ".$proveed."', '".$tipivar1."', '$ip')"; 
if (!$link->query($sql)) die ("El usuario $usuario no tiene permiso para a&ntilde;adir Apuntes.");
