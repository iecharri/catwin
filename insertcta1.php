...
echo "<label>Empresa</label>: <input type='text' name='bdatos' size='20' maxlength='20' value='$bdatos'>\n";
...
if ($bdatos) {
	...
	if (mysqli_select_db($link,$bdatos)) {
		$link->query("set names 'utf8'");
		$result = $link->query("SELECT * FROM usuarios WHERE usuario = '$usuariocop' AND clave = SHA1('$clavecop')");
		...
		echo "<p /><input type='submit' value='A&ntilde;adir a empresa ".$empresa."'></form>\n";
