...
if (!$link OR !$_SESSION['empresa']) {
	...
	if (PRUEBA == 1) {
	// *** SERVER_PRUEBAS	echo "<li><a href='?emp=1'>Usar la de pruebas <span class='b'>Nuevocat</span></a><p /></li>";
	// *** SERVER_PRUEBAS
	}
	echo "<li>Rellenar los datos pedidos arriba con los de una Empresa que hayas creado anteriormente.</li>
	</ul>";
	echo "</div></body></html>";
	exit;
}
